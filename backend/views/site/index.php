                ...
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            ...
                            <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo Yii::$app->formatter->asCurrency($totalEarnings) ?></div>
                        </div>
                        <div class="col-auto">
                            <i class="fas fa-dollar-sign fas fa-calendar fa-2x text-gray-300"></i>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card border-left-success shadow h-100 py-2">
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        ...
                        <div class="col-auto">
                            <i class="fas fa-file-alt text-white fa-2x text-gray-300"></i>
                        </div>
                    </div>
                </div>
            </div>
        </div> <!-- Orders Made Card Example -->
        <div class="col-xl-3 col-md-6 mb-4">
            <div class="card border-left-success shadow h-100 py-2">
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
